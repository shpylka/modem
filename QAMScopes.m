...
classdef QAMScopes < matlab.System
    ...
    properties (Access=private)
        ...
        pProcessConstellation
    end
    
    methods
        function obj = QAMScopes(varargin)
    ...
    methods (Access=protected)
        function setupImpl(obj, ~, ~, ~,~)
            ...
            obj.pProcessConstellation = comm.ConstellationDiagram( ...
                    'ShowGrid', true, ...
        ...
        function stepImpl(obj, RCRxSignal, coarseCompBuffer, timingRecBuffer,temp)
        ...
        function resetImpl(obj)
            ...
            reset(obj.pProcessConstellation);
        ...
        function releaseImpl(obj)
            ...
            release(obj.pProcessConstellation);
