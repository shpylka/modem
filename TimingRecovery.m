    ...
    methods (Access=private)
        ...
        function Out = interpfilter(obj,in)
            ...
            Out = obj.pDelayBuffer2 + ...
                (K*(-in+obj.pDelayBuffer1+obj.pDelayBuffer2-obj.pDelayBuffer3)-obj.pDelayBuffer2 + obj.pDelayBuffer1)*obj.pMU +...
                 K*(-obj.pDelayBuffer1-obj.pDelayBuffer2+in+obj.pDelayBuffer3)*obj.pMU^2;
            
%             
%              Out = obj.pDelayBuffer2 + ...
%                  obj.pMU*(-in/6 + obj.pDelayBuffer1 - obj.pDelayBuffer2/2 - obj.pDelayBuffer3/3)+...
%                  obj.pMU^2*(obj.pDelayBuffer1/2 - obj.pDelayBuffer2 + obj.pDelayBuffer3/2)+...
%                  obj.pMU^3*(in/6 - obj.pDelayBuffer1/2 + obj.pDelayBuffer2/2 - obj.pDelayBuffer3/6);
        ...
        function e = TED(obj,in)
            ...
            if obj.pStrobe && obj.pDelayStrobe~=obj.pStrobe
                ...
                e = real(obj.pTEDDelay1) * ((real(obj.pTEDDelay2)) -  (real(in))) + imag(obj.pTEDDelay1) * ((imag(obj.pTEDDelay2)) - (imag(in)));
